...
static void gdk_qnxscreen_gl_context_begin_frame (GdkDrawContext* draw_context, gboolean prefers_high_depth, cairo_region_t* region)
{
...
static void gdk_qnxscreen_gl_context_end_frame (GdkDrawContext* draw_context, cairo_region_t* painted)
{
...
static void gdk_qnxscreen_gl_context_class_init (GdkQnxScreenGLContextClass* class)
{
...
static void gdk_qnxscreen_gl_context_init (GdkQnxScreenGLContext* self)
{
}


gpointer gdk_qnxscreen_display_get_egl_display (GdkDisplay* display)
{
