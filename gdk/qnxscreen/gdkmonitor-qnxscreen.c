...
static void
gdk_qnxscreen_monitor_init (GdkQnxScreenMonitor *monitor)
{
...
static void
gdk_qnxscreen_monitor_class_init (GdkQnxScreenMonitorClass *class)
{
  GDK_DEBUG (MISC, "%s initializing GdkQnxScreenMonitorClass", QNX_SCREEN);
}

int
gdk_qnxscreen_monitor_init_from_qnxscreen (GdkMonitor *monitor, screen_display_t qnx_screen_display)
{
  GDK_DEBUG (MISC, "%s initializing GdkQnxScreenMonitor", QNX_SCREEN);
