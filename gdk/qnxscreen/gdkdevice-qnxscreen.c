...
static void
copy_qnxscreen_device (const GdkQnxScreenDevice *src, GdkQnxScreenDevice *dest)
{
...
static void
gdk_qnxscreen_device_set_surface_cursor (GdkDevice *device, GdkSurface *surface, GdkCursor *cursor)
{
}

static GdkSurface *
gdk_qnxscreen_device_surface_at_position (GdkDevice *device, double *win_x, double *win_y, GdkModifierType *mask)
{
...
gdk_qnxscreen_device_grab (GdkDevice *device, GdkSurface *surface, gboolean owner_events, GdkEventMask event_mask, GdkSurface *confine_to, GdkCursor *cursor, guint32 time_)
{
  return GDK_GRAB_SUCCESS;
}

static void
gdk_qnxscreen_device_ungrab (GdkDevice *device, guint32 time_)
{
}

static void
gdk_qnxscreen_device_init (GdkQnxScreenDevice *device)
{
...
static void
gdk_qnxscreen_device_class_init (GdkQnxScreenDeviceClass *class)
{
...
int
gdk_qnxscreen_device_init_seat (GdkDisplay *display)
{
...
static void
gdk_qnxscreen_device_surface_destroyed (GdkDevice *device, GdkSurface *surface)
{
  GdkQnxScreenDevice *impl = GDK_QNXSCREEN_DEVICE (device);
...
void
gdk_qnxscreen_device_seat_surface_destroyed (GdkDisplay *display, GdkSurface *surface)
{
...
gdk_qnxscreen_buttons_to_mask (int buttons)
{
...
static void
emit_button_events (GdkDisplay *display, GdkDevice *device, GdkQnxScreenDevice *prev_pointer)
{
...
static void
emit_surface_crossing_event (GdkDisplay *display, GdkQnxScreenDevice *pointer, GdkQnxScreenDevice *prev_pointer)
{
...
void
gdk_qnxscreen_device_pointer_event (GdkDisplay *display)
{
  ...
  if (0 == ret)
    {
      ...
      GDK_DEBUG (
          ...
          QNX_SCREEN,
          (touch_type == GDK_TOUCH_BEGIN ? "GDK_TOUCH_BEGIN" : touch_type == GDK_TOUCH_UPDATE ? "GDK_TOUCH_UPDATE"
                                                           : touch_type == GDK_TOUCH_END      ? "GDK_TOUCH_END"
                                                                                              : "GDK_TOUCH_CANCEL"),
          touch_sequence,
          touch_state->window_pos[0],
          touch_state->window_pos[1],
...
void
gdk_qnxscreen_device_touch_event (GdkDisplay *display, int type)
{
...
void
gdk_qnxscreen_inputcontrol_event (GdkDisplay *display, int subtype)
{
  GdkQnxScreenDisplay *display_impl = GDK_QNXSCREEN_DISPLAY (display);
...
void
gdk_qnxscreen_device_keyboard_event (GdkDisplay *display)
{
...
void
gdk_qnxscreen_device_query_state (GdkDevice *device, GdkSurface *surface, double *win_x, double *win_y, GdkModifierType *mask)
{
