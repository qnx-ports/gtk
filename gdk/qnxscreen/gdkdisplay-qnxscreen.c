...
static const char * gdk_qnxscreen_display_get_name(GdkDisplay* display)
{
  g_return_val_if_fail (GDK_IS_DISPLAY (display), NULL);
  return (char *) "QNX Screen";
}

static gboolean gdk_qnxscreen_display_get_setting(GdkDisplay* display, const char* name, GValue* value)
{
...
static GListModel* gdk_qnxscreen_display_get_monitors(GdkDisplay* display)
{
...
static GdkMonitor* gdk_qnxscreen_display_get_monitor_at_surface(GdkDisplay* display, GdkSurface* surface)
{
...
static gboolean gdk_qnxscreen_display_has_pending(GdkDisplay *display)
{
    GDK_DEBUG(MISC, "%s has pending", QNX_SCREEN);
    return FALSE;
}

static gulong gdk_qnxscreen_display_get_next_serial(GdkDisplay* display)
{
    static gulong serial = 0;
    return ++serial;
}

static void gdk_qnxscreen_display_notify_startup_complete(GdkDisplay* display, const char* startup_id)
{
    GDK_DEBUG(MISC, "%s startup complete", QNX_SCREEN);
}

static void gdk_qnxscreen_display_beep(GdkDisplay *display)
{
  GDK_DEBUG(MISC, "%s BEEP!", QNX_SCREEN);
}

static void gdk_qnxscreen_display_dispose(GObject* object)
{
...
static void gdk_qnxscreen_display_init(GdkQnxScreenDisplay* display)
{
...
static void gdk_qnxscreen_display_class_init(GdkQnxScreenDisplayClass* class)
{
