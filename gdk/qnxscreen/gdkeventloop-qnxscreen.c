...
static void
gdk_qnxscreen_event_queue_events (GdkDisplay *display)
{
...
void
gdk_qnxscreen_event_deliver_event (GdkDisplay *display, GdkEvent *event)
{
...
static gboolean
gdk_qnxscreen_event_check (GSource *source)
{
...
static gboolean
gdk_qnxscreen_event_dispatch (GSource *source, GSourceFunc callback, gpointer user_data)
{
  GdkDisplay *display = ((GdkQnxScreenEventSource *) source)->display;
  GdkEvent *event = NULL;
...
static gboolean
gdk_qnxscreen_event_prepare (GSource *source, gint *timeout)
{
...
int
gdk_qnxscreen_event_loop_init (GdkDisplay *display, screen_context_t context)
{
